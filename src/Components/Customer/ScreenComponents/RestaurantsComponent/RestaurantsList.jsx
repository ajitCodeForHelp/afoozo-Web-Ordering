    ...
    <>
      {
        restaurants?.length > 0 ?
          <div className="p-3">
            ...
            <div className="d-flex flex-column gap-3">
              {restaurants?.map((res, idx) => (
                <Link to={`/cafeMenu/${res.restaurantUuid}`} state={{ resDetail: res, orderType: orderType, open: res.open }}>
                  <div
                    key={idx}
          ...
          :
          <div className="m-2">
            <p className="p-3 text-center fw-semibold text-muted">
              Currently, we do not have Home Del. operation at this location. Please explore out other services, such as Cafe, Take Away or Dine-In for availablity.
            </p>
          </div>
      }
    </>
